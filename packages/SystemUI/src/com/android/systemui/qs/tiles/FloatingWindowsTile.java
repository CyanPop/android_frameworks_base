...
public class FloatingWindowsTile extends QSTile<QSTile.BooleanState> {
    ...
    private static final Intent CYANPOP_FLOATING_WINDOW = new Intent().setComponent(new ComponentName(
    ...
    mHost.startActivityDismissingKeyguard(CYANPOP_FLOATING_WINDOW);
    }
